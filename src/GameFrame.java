...
public class GameFrame
{
    ...
    private JLabel timeCounter=new JLabel();    //time, point and lives counters
    private JLabel pointCounter=new JLabel();
    private JLabel livesCounter=new JLabel();

    private GameThread gameThread=new GameThread();     //time threads
    ...
    private void difficultySetting(){
        ...
        JButton casualButton=new JButton("NORMAL");
